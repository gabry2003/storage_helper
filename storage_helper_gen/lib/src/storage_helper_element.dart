...
class StorageHelperElement<T> {
  ...
  const StorageHelperElement({this.key, this.staticKey, this.getKey, this.concateneKeys, this.type, this.onInit=false, this.description, this.defaultValue, this.defaultIsCode=false});

  void check() {
    assert(T == StorageHelperType || T == StorageHelperCustomType, "StorageHelperElement can only be of type StorageHelperType or StorageHelperCustomType");
  }
