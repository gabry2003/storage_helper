...
class StorageHelperCategory {
  /// Parent category's key
  final String parent;
  /// Category's dentification key
  /// It can be not inserted only in one category and in that case the generated class will be the main one
  final String key;
